...
def data_collection():
    ...
    '''
    file_address = '/Users/mahsasalmani/Desktop/Kaggle_Project/GiveMeSomeCredit'
...
# Loading the trained models and plotting ROC curve
trained_RF_model = pickle.load(open('RF_Classifier_updated.pkl', 'rb'))
trained_GB_model = pickle.load(open('GB_Classifier_updated.pkl', 'rb'))
plot_auc_roc(trained_RF_model.best_estimator_, train_X, train_Y, nfolds=10,class_indicator ='Random Forest Classifier')
plot_auc_roc(trained_GB_model.best_estimator_, train_X, train_Y, nfolds=10,class_indicator ='Gradient Boosting Classifier')
